...
class UpdateFunctionValvesByIdFunctionsIdIdValvesUpdateTool(BaseTool):
    """Update Function Valves By Id"""

    def get_definition(self) -> dict[str, Any]:
        """Get MCP tool definition."""
        return {
            "name": "update_function_valves_by_id_functions_id_id_valves_update",
            "description": "Update Function Valves By Id",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "id": {
    ...
    async def execute(self, arguments: dict[str, Any]) -> dict[str, Any]:
        """Execute update_function_valves_by_id_functions_id_id_valves_update operation."""
        ...
        response = await self.client.post(f"/api/v1/functions/id/{id}/valves/update", json_data=json_data)
