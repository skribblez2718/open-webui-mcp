"""Tests for TranscriptionAudioTranscriptionsTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.audio.transcription_audio_transcriptions_tool import TranscriptionAudioTranscriptionsTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestTranscriptionAudioTranscriptionsTool:
    """Tests for transcription_audio_transcriptions."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return TranscriptionAudioTranscriptionsTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "transcription_audio_transcriptions"
