"""Tests for SpeechAudioSpeechTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.audio.speech_audio_speech_tool import SpeechAudioSpeechTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestSpeechAudioSpeechTool:
    """Tests for speech_audio_speech."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return SpeechAudioSpeechTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "speech_audio_speech"
