"""Tests for ServeCacheFileCachePathTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.serves.serve_cache_file_cache_path_tool import ServeCacheFileCachePathTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestServeCacheFileCachePathTool:
    """Tests for serve_cache_file_cache_path."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return ServeCacheFileCachePathTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "serve_cache_file_cache_path"
