"""Tests for VerifyConnectionOpenaiVerifyTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.openai.verify_connection_openai_verify_tool import VerifyConnectionOpenaiVerifyTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestVerifyConnectionOpenaiVerifyTool:
    """Tests for verify_connection_openai_verify."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return VerifyConnectionOpenaiVerifyTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "verify_connection_openai_verify"
