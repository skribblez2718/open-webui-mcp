"""Tests for DownloadDbUtilsDbDownloadTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.utils.download_db_utils_db_download_tool import DownloadDbUtilsDbDownloadTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestDownloadDbUtilsDbDownloadTool:
    """Tests for download_db_utils_db_download."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return DownloadDbUtilsDbDownloadTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "download_db_utils_db_download"
