"""Tests for DownloadChatAsPdfUtilsPdfTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.utils.download_chat_as_pdf_utils_pdf_tool import DownloadChatAsPdfUtilsPdfTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestDownloadChatAsPdfUtilsPdfTool:
    """Tests for download_chat_as_pdf_utils_pdf."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return DownloadChatAsPdfUtilsPdfTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "download_chat_as_pdf_utils_pdf"
