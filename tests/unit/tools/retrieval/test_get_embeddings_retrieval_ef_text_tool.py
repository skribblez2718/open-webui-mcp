"""Tests for GetEmbeddingsRetrievalEfTextTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.retrieval.get_embeddings_retrieval_ef_text_tool import GetEmbeddingsRetrievalEfTextTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestGetEmbeddingsRetrievalEfTextTool:
    """Tests for get_embeddings_retrieval_ef_text."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return GetEmbeddingsRetrievalEfTextTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "get_embeddings_retrieval_ef_text"
