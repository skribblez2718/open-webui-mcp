"""Tests for CreateNewModelModelsCreateTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.models.create_new_model_models_create_tool import CreateNewModelModelsCreateTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestCreateNewModelModelsCreateTool:
    """Tests for create_new_model_models_create."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return CreateNewModelModelsCreateTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "create_new_model_models_create"
