"""Tests for ToggleModelByIdModelsModelToggleTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.models.toggle_model_by_id_models_model_toggle_tool import ToggleModelByIdModelsModelToggleTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestToggleModelByIdModelsModelToggleTool:
    """Tests for toggle_model_by_id_models_model_toggle."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return ToggleModelByIdModelsModelToggleTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "toggle_model_by_id_models_model_toggle"
