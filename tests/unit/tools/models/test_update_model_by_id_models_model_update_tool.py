"""Tests for UpdateModelByIdModelsModelUpdateTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.models.update_model_by_id_models_model_update_tool import UpdateModelByIdModelsModelUpdateTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestUpdateModelByIdModelsModelUpdateTool:
    """Tests for update_model_by_id_models_model_update."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return UpdateModelByIdModelsModelUpdateTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "update_model_by_id_models_model_update"
