"""Tests for UpdateConfigEvaluationsConfigTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.evaluations.update_config_evaluations_config_tool import UpdateConfigEvaluationsConfigTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestUpdateConfigEvaluationsConfigTool:
    """Tests for update_config_evaluations_config."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return UpdateConfigEvaluationsConfigTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "update_config_evaluations_config"
