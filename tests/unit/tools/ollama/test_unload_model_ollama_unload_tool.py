"""Tests for UnloadModelOllamaUnloadTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.ollama.unload_model_ollama_unload_tool import UnloadModelOllamaUnloadTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestUnloadModelOllamaUnloadTool:
    """Tests for unload_model_ollama_unload."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return UnloadModelOllamaUnloadTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "unload_model_ollama_unload"
