"""Tests for GenerateCompletionOllamaGenerateTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.ollama.generate_completion_ollama_generate_tool import GenerateCompletionOllamaGenerateTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestGenerateCompletionOllamaGenerateTool:
    """Tests for generate_completion_ollama_generate."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return GenerateCompletionOllamaGenerateTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "generate_completion_ollama_generate"
