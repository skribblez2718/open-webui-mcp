"""Tests for ShowModelInfoOllamaShowTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.ollama.show_model_info_ollama_show_tool import ShowModelInfoOllamaShowTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestShowModelInfoOllamaShowTool:
    """Tests for show_model_info_ollama_show."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return ShowModelInfoOllamaShowTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "show_model_info_ollama_show"
