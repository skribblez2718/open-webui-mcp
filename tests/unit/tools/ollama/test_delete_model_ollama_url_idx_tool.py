"""Tests for DeleteModelOllamaUrlIdxTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.ollama.delete_model_ollama_url_idx_tool import DeleteModelOllamaUrlIdxTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestDeleteModelOllamaUrlIdxTool:
    """Tests for delete_model_ollama_url_idx."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return DeleteModelOllamaUrlIdxTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "delete_model_ollama_url_idx"
