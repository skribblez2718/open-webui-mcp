"""Tests for CopyModelOllamaCopyUrlIdxTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.ollama.copy_model_ollama_copy_url_idx_tool import CopyModelOllamaCopyUrlIdxTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestCopyModelOllamaCopyUrlIdxTool:
    """Tests for copy_model_ollama_copy_url_idx."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return CopyModelOllamaCopyUrlIdxTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "copy_model_ollama_copy_url_idx"
