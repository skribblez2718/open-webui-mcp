"""Tests for UploadFileFilesTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.files.upload_file_files_tool import UploadFileFilesTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestUploadFileFilesTool:
    """Tests for upload_file_files."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return UploadFileFilesTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "upload_file_files"
