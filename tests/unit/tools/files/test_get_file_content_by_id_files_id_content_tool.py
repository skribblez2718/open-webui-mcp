"""Tests for GetFileContentByIdFilesIdContentTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.files.get_file_content_by_id_files_id_content_tool import GetFileContentByIdFilesIdContentTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestGetFileContentByIdFilesIdContentTool:
    """Tests for get_file_content_by_id_files_id_content."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return GetFileContentByIdFilesIdContentTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "get_file_content_by_id_files_id_content"
