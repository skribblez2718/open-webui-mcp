"""Tests for UpdateToolsByIdToolsIdIdUpdateTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.tools.update_tools_by_id_tools_id_id_update_tool import UpdateToolsByIdToolsIdIdUpdateTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestUpdateToolsByIdToolsIdIdUpdateTool:
    """Tests for update_tools_by_id_tools_id_id_update."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return UpdateToolsByIdToolsIdIdUpdateTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "update_tools_by_id_tools_id_id_update"
