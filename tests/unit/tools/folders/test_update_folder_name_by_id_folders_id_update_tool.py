"""Tests for UpdateFolderNameByIdFoldersIdUpdateTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.folders.update_folder_name_by_id_folders_id_update_tool import UpdateFolderNameByIdFoldersIdUpdateTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestUpdateFolderNameByIdFoldersIdUpdateTool:
    """Tests for update_folder_name_by_id_folders_id_update."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return UpdateFolderNameByIdFoldersIdUpdateTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "update_folder_name_by_id_folders_id_update"
