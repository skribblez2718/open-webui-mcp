"""Tests for CreateFolderFoldersTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.folders.create_folder_folders_tool import CreateFolderFoldersTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestCreateFolderFoldersTool:
    """Tests for create_folder_folders."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return CreateFolderFoldersTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "create_folder_folders"
