"""Tests for DeleteTagByIdAndTagNameChatsIdTagsTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.chats.delete_tag_by_id_and_tag_name_chats_id_tags_tool import DeleteTagByIdAndTagNameChatsIdTagsTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestDeleteTagByIdAndTagNameChatsIdTagsTool:
    """Tests for delete_tag_by_id_and_tag_name_chats_id_tags."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return DeleteTagByIdAndTagNameChatsIdTagsTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "delete_tag_by_id_and_tag_name_chats_id_tags"
