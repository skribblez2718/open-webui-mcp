"""Tests for ImportChatChatsImportTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.chats.import_chat_chats_import_tool import ImportChatChatsImportTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestImportChatChatsImportTool:
    """Tests for import_chat_chats_import."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return ImportChatChatsImportTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "import_chat_chats_import"
