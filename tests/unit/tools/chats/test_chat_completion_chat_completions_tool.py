"""Tests for ChatCompletionChatCompletionsTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.chats.chat_completion_chat_completions_tool import ChatCompletionChatCompletionsTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestChatCompletionChatCompletionsTool:
    """Tests for chat_completion_chat_completions."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return ChatCompletionChatCompletionsTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "chat_completion_chat_completions"
