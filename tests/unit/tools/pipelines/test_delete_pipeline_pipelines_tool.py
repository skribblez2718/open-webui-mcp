"""Tests for DeletePipelinePipelinesTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.pipelines.delete_pipeline_pipelines_tool import DeletePipelinePipelinesTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestDeletePipelinePipelinesTool:
    """Tests for delete_pipeline_pipelines."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return DeletePipelinePipelinesTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "delete_pipeline_pipelines"
