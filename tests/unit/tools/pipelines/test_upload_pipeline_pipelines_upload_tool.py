"""Tests for UploadPipelinePipelinesUploadTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.pipelines.upload_pipeline_pipelines_upload_tool import UploadPipelinePipelinesUploadTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestUploadPipelinePipelinesUploadTool:
    """Tests for upload_pipeline_pipelines_upload."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return UploadPipelinePipelinesUploadTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "upload_pipeline_pipelines_upload"
