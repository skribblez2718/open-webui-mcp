"""Tests for UpdateNoteByIdNotesIdUpdateTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.notes.update_note_by_id_notes_id_update_tool import UpdateNoteByIdNotesIdUpdateTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestUpdateNoteByIdNotesIdUpdateTool:
    """Tests for update_note_by_id_notes_id_update."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return UpdateNoteByIdNotesIdUpdateTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "update_note_by_id_notes_id_update"
