"""Tests for CreateNewNoteNotesCreateTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.notes.create_new_note_notes_create_tool import CreateNewNoteNotesCreateTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestCreateNewNoteNotesCreateTool:
    """Tests for create_new_note_notes_create."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return CreateNewNoteNotesCreateTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "create_new_note_notes_create"
