"""Tests for UpdateGroupByIdGroupsIdIdUpdateTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.groups.update_group_by_id_groups_id_id_update_tool import UpdateGroupByIdGroupsIdIdUpdateTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestUpdateGroupByIdGroupsIdIdUpdateTool:
    """Tests for update_group_by_id_groups_id_id_update."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return UpdateGroupByIdGroupsIdIdUpdateTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "update_group_by_id_groups_id_id_update"
