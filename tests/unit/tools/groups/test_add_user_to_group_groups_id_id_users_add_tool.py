"""Tests for AddUserToGroupGroupsIdIdUsersAddTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.groups.add_user_to_group_groups_id_id_users_add_tool import AddUserToGroupGroupsIdIdUsersAddTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestAddUserToGroupGroupsIdIdUsersAddTool:
    """Tests for add_user_to_group_groups_id_id_users_add."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return AddUserToGroupGroupsIdIdUsersAddTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "add_user_to_group_groups_id_id_users_add"
