"""Tests for CreateNewGroupGroupsCreateTool."""

import pytest
from unittest.mock import AsyncMock, Mock
from src.tools.groups.create_new_group_groups_create_tool import CreateNewGroupGroupsCreateTool
from src.exceptions import ValidationError, NotFoundError, HTTPError


class TestCreateNewGroupGroupsCreateTool:
    """Tests for create_new_group_groups_create."""
    ...
    def tool(self, mock_client, mock_config):
        ...
        return CreateNewGroupGroupsCreateTool(client=mock_client, config=mock_config)

    def test_get_definition(self, tool):
        """Test tool definition structure."""
        definition = tool.get_definition()

        assert definition["name"] == "create_new_group_groups_create"
